...
const links = {
  foundation: [
    ...
    { label: "Talleres", href: "/nosotros#talleres" },
    { label: "Impacto", href: "/nosotros#impacto" },
  ],
  products: [
    { label: "Suculentas", href: "/productos?categoria=suculentas" },
    { label: "Jabones Artesanales", href: "/productos?categoria=jabones" },
    { label: "Galletas Artesanales", href: "/productos?categoria=galletas" },
  ],
  corporate: [
    { label: "Regalos Corporativos", href: "/corporativo" },
    { label: "RSE", href: "/corporativo#rse" },
