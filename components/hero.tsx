  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/images/hero.jpg"
          alt="Productos artesanales de Fundación TAÑI"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-24 pb-16">
        <div className="max-w-2xl">
          ...
          <h1 className="font-serif text-6xl sm:text-7xl lg:text-8xl font-bold text-white leading-[1.05] text-balance mb-6">
            Productos con{" "}
